...
//Where exactly mainMethod will be stored - it is static - so always be stored inside the CMA/Meta space
...
//JVM should not create any object, object should be created by user. Object should be created based upon our business requirement
...
//we are not writing "search" or "login" functionality in main method
...
public class MainMethodConcept {
    ...
    public static void main(String a[]) { //If we comment/remove this main method then we won't have the option to run this program //JVM designed that way that it will look for this(String []) specific parameter
        System.out.println("this is the main guy");

        MainMethodConcept.main(10);
        MainMethodConcept.main(10, "Naveen");

//We can not write another method inside the main method
    /*    public static void niam (String a[]){
        ...
        //instead of main we can use any other method name as well but in that case we need to call from another main method/ class. Because JVM specifically  look for "public static void main(String[] args)" because it's predefine in java
...
//static driver is stored in CMA
...
// So we will be able to achieve  parallel execution as well.

//
//🚫 No, you cannot write a method inside the main() method in Java.
//
//Java does not allow nested method definitions (a method inside another method).
//
//That’s why your code like this 👇 will NOT compile:

//public static void main(String a[]) {
//    System.out.println("this is the main guy");
//
//    public static void niam(String a[]) {  // ❌ Not allowed
//        System.out.println("this is the main guy");
//    }
//}

//You’ll get a compile-time error like: You’ll get a compile-time error


//✅ Why this happens
//In Java:
//Methods can only be defined inside a class or interface, not inside another method or constructor.
//The main() method is just a normal static method — not a special “container” that can hold other method definitions.

/*
| Question                              | Answer                                                                             |
        | ------------------------------------- | -------------------------------------------------------------------------- |
        | Can we define a method inside main()? | ❌ No                                                                      |
        | Why not?                              | Java doesn’t support nested methods                                        |
        | Where should we define methods?       | Inside the class, but outside any other method                             |
        | What’s allowed inside main()?         | Variable declarations, loops, if-else, object creation, method calls, etc. |
*/
