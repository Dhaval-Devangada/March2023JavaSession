...
/**
 * Added "return 45" inside the try block
 * Added "return 85" inside the catch block
 * Add finally block with "return 100"
 * Now wha will be the o/p ? will it return 45 or 100?
 */
public class StudentFive {
    ...
    public static void main(String[] args) {
        int m1 = StudentFive.getStudentMarks("shubham");
        System.out.println(m1);
    }
}
/**
 * What is the result of m1? or m1 will return what? > 45 or 100
 ...
 * so "return 100" will replace "return 45"
 * Java will try to return 45 but also will check that do you have finally block? if yes then execute it and return from there
 * so 100 will be replacing 45
