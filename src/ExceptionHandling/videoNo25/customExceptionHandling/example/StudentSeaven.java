...
/**
 * We are adding System.exit(0); in catch block because in this program exception is coming
 * so java will return 45 or 100? or it will not return anything
 */
public class StudentSeaven {
    ...
    public static void main(String[] args) {
        int m1 = StudentSeaven.getStudentMarks("shubham");
...
/**
 * So in which condition "finally" block will not be executed
 * When we use "System.exit(0)" in our try/catch block then it will terminate the program
 */

/**
 * Any good use case of try-catch and finally block?
 * Refer finally block example
 */