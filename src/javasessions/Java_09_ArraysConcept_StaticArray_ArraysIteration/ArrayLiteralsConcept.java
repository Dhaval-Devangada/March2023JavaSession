...
//		System.out.println(k[2]);//0 // Here we have not store any value so it is giving 0
        ...
        // In integer we can not have the null
        ...
        //solution: Java says if we know the values already then we can use the literals
        ...
        p[9] = 600;
        System.out.println("Updated array"+ Arrays.toString(p));
