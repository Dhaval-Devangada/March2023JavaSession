package javasessions.Java_08_Loops_DoWhile_Examples_UseCasesOfLoops;
...
public class LoopsConcept_2 {
    public static void main(String[] args) {
        ...
        // do-while:
        // start the loop -> execute the statement - > check the condition -> true -> again execute statement
        //false ->exit
        // so here statement will be executed at least once
        ...
        // drop down -- default value ---> taking  0, 2, 5, 10 seconds to load from the database / sometimes it is already selected

        System.out.println("----------");

        // we can use break in the do-while loop
        int l = 1;
        do {
        ...
        // can we use double with loop: Yes
...
//		}
        ...
        // can we use Characters with loop: Yes
        //char: a to z
        for (char c = 'a'; c <= 'z'; c++) { // It will do the comparasion on the basis of the ascii value
        ...
        //can we put any conditions between this loops: YES
        for (char c = 'a'; c <= 'z'; c++) {
            System.out.println(c);
            if (c == 'y') {
        ...
        //infinite loop is bad if we are not breaking it
        int pointer = 0;
        while (true) {
            System.out.println("checking the element in attempt : " + pointer);

            if (pointer == 10) { // here after 10 second we are breaking it
