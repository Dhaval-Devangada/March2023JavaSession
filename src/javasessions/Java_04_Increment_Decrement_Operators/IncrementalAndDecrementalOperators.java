package javasessions.Java_04_Increment_Decrement_Operators;

public class IncrementalAndDecrementalOperators {

    public static void main(String[] args) {

        //Always draw memory diagram for these kind of questions

        //(increase the value by 1) ++ / (descre the value byb 1) --

        // 1. post increment: ++ : first assign then increase
        // understand this with memory diagram
        int a = 1;
        int b = a++;
        ...
        //We can apply on doubles as well
        //post increment
        double d1 = 1.1;
        double d2 = d1++;
        ...
        //We can apply on characters
        char c1 = 'a';// 97
        char c2 = ++c1;
        System.out.println(c1);// 98->b
        System.out.println(c2);// 98->b

        // 3. post decrement: -- first assign then decrese
        int p = 2;
        int q = p--;
        ...
        // 4. pre decrement: -- First decrese then assign
        int h1 = 2;
        int h2 = --h1;
        ...
        int pop = 8;
        System.out.println(++pop);// println will consume the incresed value
        System.out.println(pop);

        //
        char ch = '0';// 48
        System.out.println("Pre-increment on characters " + ++ch);// 48+1 = 49 --> '1'

        char ch1 = '$';
        System.out.println("Pre-increment on characters " + ++ch1);  // This will give %

        char ch2 = 'a';
        System.out.println("Post-increment on characters " + ch2++);// a
        System.out.println("Post-increment on characters " + (byte) ch2);// b

        // We can not increase/decrese the value of boolean
//		boolean flag = true;
//		System.out.println(flag++);

        // We can not increse/descrease the value of string
//		String s = "hello";
...
// ++ and -- will always be applied on variable and not directly on the value
//Calculation will happen based on the current value which in the memory